 ...
 */
@Entity
@Table(name = "test_dep", schema = "")
@SuppressWarnings("serial")
public class TestDepEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="DEP_NAME",nullable=true,length=32)
	...
	@Column(name ="DEP_CODE",nullable=false,length=32)
