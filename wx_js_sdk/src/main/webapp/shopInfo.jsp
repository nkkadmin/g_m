	...
	<div class="inner" id="inner">
		<div class="wrap">
			<div class="header">
				...
				<div class="owner">
					<span class="date"> <em id="timeId">2017-11-02</em></span> <a
			...
			<p style="text-align: center;">
				<img style="max-width: 100%;" src="${ctx }/images/1.png">
			</p>
			...
			<p>
				<a name="todo" class="btn"
					...
					<img style="max-width: 100%;" src="${ctx }/images/button.png">
				</a>
			</p>
			<p style="text-align: center;">
			...
			<p align="center" style="text-align: center;">
				<img style="max-width: 100%;" src="${ctx }/images/2.png">
			</p>
			<p>
				<a name="todo" class="btn"
					style="display: block; color: rgb(255, 255, 255); background-color: rgb(255, 0, 0); width: 100%; padding: 10px 0px; text-align: center; text-decoration: none; margin-bottom: 10px;">
...
<script>
	...
	var link = ${shareUrl}; // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
