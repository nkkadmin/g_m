...
if (function () {
    ...
    app.strToCode = function (n) {
        for (var r = "", i, t = 0; t < n.length; t++) i = "0000" + parseInt(n[t].charCodeAt(0), 10).toString(16), r += i.substring(i.length - 4, i.length);
        return r
    };
    ...
    Url = function () {
        ...
        return n.prototype.GetHref = function (n) {
            ...
            if ("all" !== n.removeParams)
                for (t in i.params) i.params.hasOwnProperty(t) && (r[t] = i.params[t]);
            if (n.params)
                for (t in n.params) n.params.hasOwnProperty(t) && (r[t] = n.params[t]);
            if ("all" !== n.removeParams && (e = n.removeParams, e))
                for (t in e) n.removeParams.hasOwnProperty(t) && (s = n.removeParams[t], delete r[s]);
            u = [];
    ...
    Main = function () {
        ...
        return n.prototype.isNeedRedirect = function () {
            ...
            if (window.wcShare) {
                ...
                if (isUrl(this.nextUrl)) return t.link = this.nextUrl, void(window.wcShare.shareData = t);
                var u = void 0,
                    f = void 0,
                    e = void 0,
                ...
                if (this.nextUrl && (u = this.nextUrl, f = this.fileName, e = "", o = "share-user-ok"), r = {
                    ...
                    for (i in n.linkParams) n.linkParams.hasOwnProperty(i) && (s = n.linkParams[i], r.params[i] = s);
